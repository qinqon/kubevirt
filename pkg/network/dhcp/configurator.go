...
func NewConfiguratorWithClientFilter(cacheFactory cache.InterfaceCacheFactory, launcherPID string, advertisingIfaceName string, handler Handler) *Configurator {
	return &Configurator{
...
func NewConfigurator(cacheFactory cache.InterfaceCacheFactory, launcherPID string, advertisingIfaceName string, handler Handler) *Configurator {
	return &Configurator{
		advertisingIfaceName: advertisingIfaceName,
		cacheFactory:         cacheFactory,
		launcherPID:          launcherPID,
...
func (d Configurator) EnsureDhcpServerStarted(podInterfaceName string, dhcpConfig Configuration, dhcpOptions *v1.DHCPOptions) error {
